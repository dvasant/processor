...
func (this *WriterHandlerFixture) Setup() {
	...
	this.handler = NewWriteHandler(this.input, this.buffer)
}
...
var recordMatchingValues = AddressOutput{
	Status:        "Status",
...
func (this *WriterHandlerFixture) TestHeaderMatchesRecords() {
	this.input <- &Envelope{Output: recordMatchingValues}
	close(this.input)
	this.handler.Handle()
...
func (this *WriterHandlerFixture) TestAllEnvelopeWritten() {
